        ...
        <div id='contato' className='flex flex-col md:justify-normal overflow-hidden w-screen min-h-screen' style={{ backgroundColor: '#D8D8D8' }}>
            <div className='flex flex-col justify-center items-center w-full h-72 md:h-96 text-center font-Oswald md:items-start' style={{ background: 'linear-gradient(180deg, #002E74 0%, #1B52A5 50.5%, #002E74 97.5%)' }}>
                <div className='md:w-1/2 md:flex md:justify-center md:items-center md:flex-col md:gap-2 md:mt-20'>
                    <h1 className='text-2xl font-bold text-white sm:text-3xl lg:text-4xl xl:text-5xl'>{!isEnglish ? 'Vamos conversar!' : "Let's talk!"}</h1>
                    <h1 className='text-2xl font-bold text-white sm:text-3xl lg:text-4xl xl:text-5xl'>{!isEnglish ? 'Vamos fale-me sobre o seu Projeto' : "Tell me about your Project"}</h1>
            ...
            <div className='md:flex md:gap-6 lg:gap-16 xl:gap-24 2xl:gap-64'>
                <div>
                    <div onClick={() => handleNavigate('whatsapp')} className='cursor-pointer relative -top-20 bg-white mx-4 rounded-md mb-5 md:-top-0 md:w-[380px] md:mt-20 md:ml-6 md:mb-0 lg:w-[435px] lg:ml-16 xl:w-[535px] xl:ml-28'>
                    ...
                    <div className='relative -top-20 bg-white mx-4 rounded-md mb-5 md:-top-0 md:w-[380px] md:mt-6 md:ml-6 md:mb-0 lg:w-[435px] lg:ml-16 xl:w-[535px] xl:ml-28'>
                        <div className='flex flex-col justify-center items-center md:flex-row md:justify-start md:items-center md:pl-6 md:gap-3 '>
                            <div className='flex justify-center items-center w-14 h-14 md:w-16 md:h-16 rounded-full mt-2 mb-0 md:mt-0' style={{ backgroundColor: '#E2E2E2' }}>
                ...
                <div>
                    <div className='relative -top-12 bg-white mx-4 rounded-md font-Oswald text-center p-2 font-light md:w-[300px] md:-mt-16 md:p-2 lg:w-[400px] lg:-mt-20 lg:p-4 xl:w-[480px] xl:-mt-28 xl:p-6 2xl:w-[580px]'>
                        ...
                        <form ref={form} onSubmit={sendEmail}>
                            <div className='md:flex md:flex-col md:gap-4'>
                                ...
                                <div className='flex mt-2 border-blue-900 border-2 rounded-md'>
                                    <div className='h-8 md:h-12 md:w-14 flex items-center justify-center p-2 rounded-l-md' style={{ backgroundColor: '#C5C5C5' }}>
                                        <img src={email2} width={20} alt='email'/>
                                    </div>
                                ...
                                <div className='flex mt-2 border-blue-900 border-2 rounded-md'>
                                    <div className='h-8 md:h-12 md:w-14 flex items-center justify-center p-2 rounded-l-md' style={{ backgroundColor: '#C5C5C5' }}>
                                        <img src={assunto} width={20} alt='assunto' />
                                    </div>
                                ...
                                <div className='flex flex-col mt-2'>
                                    ...
                                    <textarea name="message" rows={6} placeholder={!isEnglish ? 'Conte-me mais...' : "Tell-me more..."} className='w-full rounded-r-md p-1 focus:outline-none rounded-md border-2 border-blue-900' style={{ backgroundColor: '#E2E2E2' }} />
                                </div>
                            </div>
            ...
            <footer className='relative bottom-0 border-t-2 bg-white md:mt-32' style={{ borderColor: '#C5C5C5' }}>
