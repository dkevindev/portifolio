                        ...
                        <form action="">
                            <div className='md:flex md:flex-col md:gap-4'>
                                <div className='flex mt-2 border-blue-900 border-2 rounded-md'>
                                    ...
                                    <input type="text" placeholder={!isEnglish ? 'Digite seu nome' : "Type your name"} className='h-8 md:h-12 w-full rounded-r-md pl-2 focus:outline-none' style={{ backgroundColor: '#E2E2E2' }} />
                                </div>
                                <div className='flex mt-2 border-blue-900 border-2 rounded-md'>
                                    <div className='h-8 md:h-12 md:w-14 flex items-center justify-center p-2 rounded-l-md' style={{ backgroundColor: '#C5C5C5' }}>
                                        <img src={email2} width={20} />
                                    </div>
                                    <input type="text" placeholder={!isEnglish ? 'Digite seu email' : "Type your e-mail"} className='h-8 md:h-12 w-full rounded-r-md pl-2 focus:outline-none' style={{ backgroundColor: '#E2E2E2' }} />
                                </div>
                                <div className='flex mt-2 border-blue-900 border-2 rounded-md'>
                                    <div className='h-8 md:h-12 md:w-14 flex items-center justify-center p-2 rounded-l-md' style={{ backgroundColor: '#C5C5C5' }}>
                                        <img src={assunto} width={20} />
                                    </div>
                                    <input type="text" placeholder={!isEnglish ? 'Digite o assunto' : "Enter the subject"} className='h-8 md:h-12 w-full rounded-r-md pl-2 focus:outline-none' style={{ backgroundColor: '#E2E2E2' }} />
                                </div>
                                <div className='flex flex-col mt-2'>
                                    ...
                                    <textarea name='corpo' rows={6} placeholder={!isEnglish ? 'Digite o assunto' : "Enter the subject"} className='w-full rounded-r-md p-1 focus:outline-none rounded-md border-2 border-blue-900' style={{ backgroundColor: '#E2E2E2' }} />
                                </div>
                            </div>
                            <button className='bg-blue-900 px-2 py-1 self-center text-white rounded-md mt-4'>{!isEnglish ? 'ENVIAR' : "SEND"}</button>
                        </form>
                    </div>
                </div>
            </div>
