        ...
        <div id='projetos' className='flex flex-col md:justify-normal overflow-hidden' style={{ backgroundColor: '#D8D8D8' }}>
            <div className='flex flex-col'>
                <div className='w-full h-80 md:h-96 text-center font-Oswald' style={{ background: 'linear-gradient(180deg, #80C979 0%, rgba(100, 168, 93, 0.75) 50.5%, #498943 97.5%)' }}>
                    <h1 className='mt-28 text-3xl md:text-5xl font-medium'>Explore meus <span className='text-white'>Projetos .</span></h1>
                    <h1 className='font-extralight md:text-3xl text-xl mx-7 my-1 text-white'>Tenha sucesso online com um site rápido, fácil de usar e construído com as melhores práticas e paixão pelo design.</h1>
                </div>
