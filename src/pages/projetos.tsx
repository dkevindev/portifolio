...
export const Projetos = () => {
    return (
        <>
            <div id='sobre' className='flex flex-col justify-between h-full md:justify-normal' style={{ backgroundImage: "url('/89781.jpg')", backgroundRepeat: 'repeat', backgroundSize: 'cover', }}>
