...
export const Home = () => {
    return (
        <>
            <div className='flex flex-col justify-between h-screen md:justify-normal ' style={{ backgroundImage: "url('/89781.jpg')", backgroundRepeat: 'repeat', backgroundSize: 'cover' }}>
